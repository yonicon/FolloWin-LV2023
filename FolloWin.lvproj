...
<Project Type="Project" LVVersion="23008000">
	...
	<Property Name="NI.Project.Description" Type="Str">This is an example code project demonstratin the use of FolloWin class. 
The object is used to create a small "naked" window that follows the mouse cursor at certain hotspots. (in the demo Intensity Graph active area)</Property>
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Helpers" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="InitFormatGlobals.vi" Type="VI" URL="../Helpers/InitFormatGlobals.vi"/>
			<Item Name="StringFormatGlobals.vi" Type="VI" URL="../Helpers/StringFormatGlobals.vi"/>
			<Item Name="InitIntensityGraph.vi" Type="VI" URL="../Helpers/InitIntensityGraph.vi"/>
			<Item Name="InitXYGraph.vi" Type="VI" URL="../Helpers/InitXYGraph.vi"/>
			<Item Name="DrawStringOnFrontImage.vi" Type="VI" URL="../Helpers/DrawStringOnFrontImage.vi"/>
			<Item Name="DrawCross.vi" Type="VI" URL="../Helpers/DrawCross.vi"/>
			<Item Name="GetPlotBndsInScreenCoord.vi" Type="VI" URL="../Helpers/GetPlotBndsInScreenCoord.vi"/>
			<Item Name="BoundsToOffsetedBounds.vi" Type="VI" URL="../Helpers/BoundsToOffsetedBounds.vi"/>
			<Item Name="GraphXYto2DArrayIndexes.vi" Type="VI" URL="../Helpers/GraphXYto2DArrayIndexes.vi"/>
			<Item Name="GraphXYtoFrontImagePixels.vi" Type="VI" URL="../Helpers/GraphXYtoFrontImagePixels.vi"/>
			<Item Name="CoordToAxesXY.vi" Type="VI" URL="../Helpers/CoordToAxesXY.vi"/>
			<Item Name="ReadPointDataFromNewString.vi" Type="VI" URL="../Helpers/ReadPointDataFromNewString.vi"/>
			<Item Name="BuildPosString.vi" Type="VI" URL="../Helpers/BuildPosString.vi"/>
			<Item Name="BuildXYMeasureString.vi" Type="VI" URL="../Helpers/BuildXYMeasureString.vi"/>
			<Item Name="BuildXYPString.vi" Type="VI" URL="../Helpers/BuildXYPString.vi"/>
			<Item Name="BuildLinString.vi" Type="VI" URL="../Helpers/BuildLinString.vi"/>
			<Item Name="CreateLinPosStrings.vi" Type="VI" URL="../Helpers/CreateLinPosStrings.vi"/>
			<Item Name="ChopStringFromBothSides.vi" Type="VI" URL="../Helpers/ChopStringFromBothSides.vi"/>
			<Item Name="points2length.vi" Type="VI" URL="../Helpers/points2length.vi"/>
			<Item Name="dxdx2angle.vi" Type="VI" URL="../Helpers/dxdx2angle.vi"/>
			<Item Name="UpdateValuesFromDataString.vi" Type="VI" URL="../Helpers/UpdateValuesFromDataString.vi"/>
		</Item>
		<Item Name="SandBox" Type="Folder">
			<Item Name="SphereXYtoZ.vi" Type="VI" URL="../Helpers/SphereXYtoZ.vi"/>
			<Item Name="CreateImageFromFonts.vi" Type="VI" URL="../Helpers/CreateImageFromFonts.vi"/>
		</Item>
		<Item Name="FolloWin.lvclass" Type="LVClass" URL="../FolloWin Class/FolloWin.lvclass"/>
		<Item Name="FolloWinDemo.vi" Type="VI" URL="../FolloWinDemo.vi"/>
